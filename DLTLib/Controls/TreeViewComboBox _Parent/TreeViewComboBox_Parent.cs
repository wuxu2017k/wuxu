...
namespace DLTLib.Controls.TreeViewComboBox
{
    ...
    /// </summary>
    [Description("TreeViewComboBox_Parent by DLT Soft.")]
    public class TreeViewComboBox_Parent : ComboBox
    {
        /// <summary>
        /// The form to be used as custom DropDown control.
        /// </summary>
        private TreeViewComboBoxForm_Parent _treeViewForm = null;
        ...
        /// The constructor.
        /// </summary>
        public TreeViewComboBox_Parent()
        {
            _treeViewForm = new TreeViewComboBoxForm_Parent();
